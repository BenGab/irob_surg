...
best_save_path='/pretrined_models/UNET12_BCE_G_C2_best.h5'
save_path = '/pretrined_models/UNET12_BCE_G_C2.h5'
callbacks_l = [
    TensorBoard('/boards/UNET12_BCE_G_C2'),
    ReduceLROnPlateau('loss', factor=0.1, patience=2, min_lr=0.000001, verbose=1),
    EarlyStopping('loss', patience=5, verbose=1),
    ModelCheckpoint(best_save_path, 'val_acc',verbose=1, save_best_only=True, save_weights_only=True)
]
batchSize = 1
