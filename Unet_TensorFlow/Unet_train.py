...
best_save_path='/pretrined_models/UNET12_BCE_G_C3_best.h5'
save_path = '/pretrined_models/UNET12_BCE_G_C3.h5'
callbacks_l = [
    TensorBoard('/boards/UNET12_BCE_G_C3'),
    ReduceLROnPlateau('val_loss', factor=0.1, patience=2, min_lr=1e-10, verbose=1),
    EarlyStopping('val_loss', patience=20, verbose=1),
...
model.fit_generator(datagen_train, epochs=100, steps_per_epoch=data.data_train_len(), callbacks=callbacks_l,
